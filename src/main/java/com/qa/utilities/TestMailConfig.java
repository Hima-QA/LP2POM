...
public class TestMailConfig{
	...
	public static String from = "testtek789@gmail.com";
	public static String password = "usertek@#789#";
	public static String[] to ={"hima.sahadevan5@gmail.com","testtek789@gmail.com"};
